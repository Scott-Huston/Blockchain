...
def mine():
    ...
    # checking that proof and id fields exist
    if not ('proof' in data) and ('id' in data):
        response = {
            'message': 'missing proof and/or id fields'
        }
